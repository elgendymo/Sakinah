...
export default function TazkiyahPage() {
  ...
  const COMMON_STRUGGLES = {
    takhliyah: [
      ...
      t('commonStruggles.showingOff'),
      t('commonStruggles.seekingFame'),
      t('commonStruggles.greed'),
      t('commonStruggles.miserliness'),
      t('commonStruggles.lust'),
      t('commonStruggles.anger'),
      t('commonStruggles.malice'),
      t('commonStruggles.backbiting'),
      t('commonStruggles.slander'),
      t('commonStruggles.suspicion'),
      t('commonStruggles.loveDunya'),
      t('commonStruggles.heedlessness'),
      t('commonStruggles.hypocrisy'),
      t('commonStruggles.despair'),
      t('commonStruggles.falseHope'),
      t('commonStruggles.laziness'),
      t('commonStruggles.arroganceKnowledge'),
      t('commonStruggles.lovePraise'),
      t('commonStruggles.fearCriticism'),
      t('commonStruggles.selfDeception'),
      t('commonStruggles.insincerity'),
      t('commonStruggles.delayingRepentance'),
    ],
    tahliyah: [
